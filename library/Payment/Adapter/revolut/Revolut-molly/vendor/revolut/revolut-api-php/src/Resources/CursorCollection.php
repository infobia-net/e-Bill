...
abstract class CursorCollection extends BaseCollection
{
     ...
     */
    final public function __construct(RevolutApiClient $client, $count, $_links)
    {
    ...
    final public function next()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->next->href);
    ...
    final public function previous()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->previous->href);
