...
use Revolut\Api\Resources\Terminal;
use Revolut\Api\Resources\TerminalCollection;
...
class TerminalEndpoint extends CollectionEndpointAbstract
{
    ...
    /**
     * Retrieve terminal from Revolut.
     *
    ...
    /**
     * Retrieves a collection of Terminals from Revolut for the current organization / profile, ordered from newest to oldest.
     *
