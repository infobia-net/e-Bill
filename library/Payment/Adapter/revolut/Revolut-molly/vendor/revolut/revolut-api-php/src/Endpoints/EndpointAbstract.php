...
{
    public const REST_CREATE = RevolutApiClient::HTTP_POST;
    public const REST_UPDATE = RevolutApiClient::HTTP_PATCH;
    public const REST_READ = RevolutApiClient::HTTP_GET;
    public const REST_LIST = RevolutApiClient::HTTP_GET;
    public const REST_DELETE = RevolutApiClient::HTTP_DELETE;
    ...
    /**
     * @param RevolutApiClient $api
     */
    public function __construct(RevolutApiClient $api)
    {
        $this->client = $api;
    }
    ...
    /**
     * Sends a PATCH request to a single Revolut API object.
     *
     * @param string $id
     * @param array $body
     *
