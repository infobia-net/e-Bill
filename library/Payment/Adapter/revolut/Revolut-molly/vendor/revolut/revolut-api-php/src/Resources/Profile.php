...
use Revolut\Api\Types\ProfileStatus;
...
class Profile extends BaseResource
{
    ...
    /**
     * See https://docs.revolut.com/reference/v2/profiles-api/get-profile
    ...
    /**
     * @return \Revolut\Api\Resources\Profile
     * @throws ApiException
     */
    ...
    public function chargebacks()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->chargebacks->href);
    ...
    public function methods()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->methods->href);
    ...
    public function payments()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->payments->href);
    ...
    public function refunds()
    {
        ...
        $result = $this->client->performHttpCallToFullUrl(RevolutApiClient::HTTP_GET, $this->_links->refunds->href);
