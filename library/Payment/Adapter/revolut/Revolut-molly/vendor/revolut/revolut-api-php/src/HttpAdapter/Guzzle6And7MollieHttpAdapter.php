...
final class Guzzle6And7RevolutHttpAdapter implements RevolutHttpAdapterInterface
{
    /**
    ...
    public static function createDefault()
    {
        ...
        return new Guzzle6And7RevolutHttpAdapter($client);
    }
    ...
    private function parseResponseBody(ResponseInterface $response)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new ApiException("Unable to decode Revolut response: '{$body}'.");
        }
    ...
    /**
     * The version number for the underlying http client, if available. This is used to report the UserAgent to Revolut,
