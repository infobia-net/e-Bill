...
use Revolut\Api\Types\PaymentStatus;
use Revolut\Api\Types\SequenceType;
...
class Payment extends BaseResource
{
    ...
    /**
     * Id of the payment (on the Revolut platform).
     *
     * @var string
     */
    public $id;
     ...
     * @param array $data
     *
     * @return \Revolut\Api\Resources\Refund
     * @throws ApiException
     */
