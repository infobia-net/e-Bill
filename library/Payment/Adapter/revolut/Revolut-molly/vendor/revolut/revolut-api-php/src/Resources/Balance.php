...
class Balance extends BaseResource
{
    ...
    /**
     * The identifier uniquely referring this balance. Revolut assigns this identifier at balance creation.
     *
     ...
     * The status is "inactive" if the account is still being validated by Revolut or if the balance has been blocked.
     *
     * @var string
     */
    public $status;
    ...
    /**
     * Links to help navigate through the Revolut API and related resources.
     *
     * @var \stdClass
     */
    public $_links;
