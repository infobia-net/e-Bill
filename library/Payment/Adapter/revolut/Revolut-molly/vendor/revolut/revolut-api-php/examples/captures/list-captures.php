<?php
/*
 * List captures for a payment using the Revolut API.
 */
...
try {
     ...
     *
     * See: https://docs.revolut.com/reference/v2/captures-api/list-captures
     */

    $payment = $revolut->payments->get('tr_WDqYK6vllg');
