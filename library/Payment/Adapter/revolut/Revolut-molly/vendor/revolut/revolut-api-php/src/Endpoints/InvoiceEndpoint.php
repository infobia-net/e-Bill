...
use Revolut\Api\Resources\Invoice;
use Revolut\Api\Resources\InvoiceCollection;
...
class InvoiceEndpoint extends CollectionEndpointAbstract
{
    ...
    /**
     * Retrieve an Invoice from Revolut.
     *
    ...
    /**
     * Retrieves a collection of Invoices from Revolut.
     *
