...
try {
    ...
    /*
     * Initialize the Revolut API library with your oauth access token.
     *
     * See: https://docs.revolut.com/connect/getting-started
     */

    $revolut = new \Revolut\Api\RevolutApiClient();
    $revolut->setAccessToken("access_dHar4XY7LxsDOtmnkVtjNVWXLSlXsM");
     ...
     *   routing       Routing part of a payment to a connected account https://docs.revolut.com/connect/splitting-payments
     *
