<?php
/*
 * Cancel order lines using the Revolut API.
 */
...
try {
     ...
     *
     * See: https://docs.revolut.com/reference/v2/orders-api/cancel-order-line
     */

    $orderId = 'ord_8wmqcHMN4U';
    $lineId = 'odl_dgtxyl';

    $order = $revolut->orders->get($orderId);
    ...
    if ($line && $line->isCancelable) {
        ...
        $updatedOrder = $revolut->orders->get($orderId);
