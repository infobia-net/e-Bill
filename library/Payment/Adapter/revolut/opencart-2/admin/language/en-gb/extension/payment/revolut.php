<?php
// Heading
$_['heading_title']                  = 'Revolut Gateway';
...
$_['error_webhook_not_setup']        = 'Warning: Webhook not set up! Please set up the Webhook by clicking on the \'Set Up\' button, otherwise orders will not be synced correctly!';
