...
class __TwigTemplate_69934a3a7bcb8bab11f453ed44f073c5 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
            ...
            <div class=\"recaptcha_only_if_incorrect_sol\" style=\"color:red\">";
                        // line 67
                        echo twig_escape_filter($this->env, __trans("Incorrect please try again"), "html", null, true);
                        echo "</div>

            <p>
                <label>";
                        // line 70
                        echo twig_escape_filter($this->env, __trans("Enter the words above"), "html", null, true);
                        echo "</label>
                <br/>
    ...
    {
        return new Source("", "macro_functions.html.twig", "/var/www/themes/fossbilling-bootstrap/html/macro_functions.html.twig");
    }
}
